    ...
    <>
      ...
      <section className="py-14 lg:py-20">
        <div className="container-wbc grid gap-8 lg:grid-cols-[1.4fr_1fr]">
          <div data-reveal className="rounded-card border border-line bg-background p-7 transition-shadow duration-300 hover:shadow-card sm:p-10">
          ...
          <aside data-reveal className="rounded-card border border-line bg-surface p-7 sm:p-8 transition-shadow duration-300 hover:shadow-card">
            ...
            <p className="mt-3 text-[15px] leading-relaxed text-muted-fg">
              Interested in establishing or reactivating affiliate presence? Start with the application form or review
