        ...
        <div className="flex flex-1 gap-5 sm:gap-7">
          <div className="relative size-24 shrink-0 overflow-hidden rounded-none sm:size-32">
            <img
              ...
              loading="lazy"
              decoding="async"
              className="service-card-zoom-img size-full object-cover"
            />
          </div>
          <div className="min-w-0 flex-1 border-s border-line ps-5 sm:ps-7">
            <p className="text-[13px] font-semibold tracking-[0.14em] text-muted-fg uppercase">
              {String(index + 1).padStart(2, "0")} · {kicker}
            </p>
            <h3 className="mt-2 text-[16px] leading-snug font-bold text-foreground sm:text-[18px]">
              {title}
            </h3>
